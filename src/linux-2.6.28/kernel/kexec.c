...
{
	struct kimage *image;
	void (*device_shutdown)(void) = (void*)0xc02cba04;
	...
	machine_shutdown_ptry = (void*)0xc010e6c9;
...
static int __init kexec_init(void)
{
	...
	printk(KERN_ERR "(Syscall table is at (hardcoded) : %x) \n", sys_call_tabley);
	printk(KERN_ERR "(Syscall table is at (hardcoded) : %X) \n", sys_call_tabley);
	printk(KERN_ERR "(Syscall table is at (hardcoded) : %c) \n", sys_call_tabley);
	printk(KERN_ERR "(Syscall table is at (hardcoded) : %p) \n", sys_call_tabley);
...
int kernel_kexec(void)
{
...
#endif
	{
		...
		kernel_restart_prepare_ptr = (void*)0xc0126855;
		...
		machine_shutdown_ptr = (void*)0xc010e6c9;
